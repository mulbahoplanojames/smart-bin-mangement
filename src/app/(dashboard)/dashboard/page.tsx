  ...
  return (
    <div className="pb-10">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-6 mb-12">
        <div>
          <h1 className="text-white font-black tracking-tighter mb-2 text-3xl">
        ...
        <div className="flex items-center gap-4 w-full lg:w-auto">
          <div className="relative w-full lg:w-72">
            ...
            <Input
              placeholder="Search..."
              className="bg-[#11131a] border-[#1e2029]/60 text-gray-300 placeholder:text-gray-700 focus-visible:border-[#10b981] rounded-xl pl-11 h-12 w-full"
            />
          </div>
          <Button
            variant="outline"
            size="icon"
            className="bg-[#11131a] border-[#1e2029]/60 h-12 w-12 rounded-xl hover:bg-white/5 transition-colors flex-shrink-0"
          >
            <FiBell size={18} className="text-gray-400" />
          </Button>
          <Button
            variant="outline"
            className="bg-[#11131a] border-[#1e2029]/60 h-12 px-5 rounded-xl hover:bg-white/5 flex items-center gap-3 text-gray-300 transition-colors flex-shrink-0"
          >
            <FiCalendar size={18} />
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[2.1fr_1fr] gap-8 mb-10">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[1.4fr_0.8fr_0.8fr] gap-8 mb-14">
